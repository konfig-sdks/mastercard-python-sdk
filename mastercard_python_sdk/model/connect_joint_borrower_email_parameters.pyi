...
class ConnectJointBorrowerEmailParameters(
    ...
    experience: MetaOapg.properties.experience
    email: 'EmailOptions'
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["partnerId", "borrowers", "email", "experience", "language", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "institutionSettings", "fromDate", "reportCustomFields", "singleUseUrl", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["experience"]) -> MetaOapg.properties.experience: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["partnerId", "borrowers", "email", "experience", "language", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "institutionSettings", "fromDate", "reportCustomFields", "singleUseUrl", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        experience: typing.Union[MetaOapg.properties.experience, str, ],
        email: 'EmailOptions',
