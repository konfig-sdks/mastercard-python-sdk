...
class PaystubMonthlyIncomeRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["estimatedMonthlyBasePay", "estimatedMonthlyOvertimePay", "estimatedMonthlyBonusPay", "estimatedMonthlyCommissionPay", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["estimatedMonthlyBasePay", "estimatedMonthlyOvertimePay", "estimatedMonthlyBonusPay", "estimatedMonthlyCommissionPay", ], str]):
