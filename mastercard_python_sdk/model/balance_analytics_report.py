...
class BalanceAnalyticsReport(
        ...
        class properties:
            ...
            class accountResults(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['BalanceAnalyticsAccountResult']:
                        return BalanceAnalyticsAccountResult
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['BalanceAnalyticsAccountResult'], typing.List['BalanceAnalyticsAccountResult']],
                ...
                def __getitem__(self, i: int) -> 'BalanceAnalyticsAccountResult':
                    return super().__getitem__(i)
            businessId = schemas.IntSchema
        
            @staticmethod
            def businessSummary() -> typing.Type['BalanceAnalyticsBusinessSummary']:
                return BalanceAnalyticsBusinessSummary
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["businessSummary"]) -> 'BalanceAnalyticsBusinessSummary': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "customerId", "reportHeader", "accountResults", "businessId", "businessSummary", "requesterName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["businessSummary"]) -> typing.Union['BalanceAnalyticsBusinessSummary', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "customerId", "reportHeader", "accountResults", "businessId", "businessSummary", "requesterName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        businessSummary: typing.Union['BalanceAnalyticsBusinessSummary', schemas.Unset] = schemas.unset,
