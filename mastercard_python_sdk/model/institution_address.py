...
class InstitutionAddress(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["city", "state", "country", "postalCode", "addressLine1", "addressLine2", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["city", "state", "country", "postalCode", "addressLine1", "addressLine2", ], str]):
