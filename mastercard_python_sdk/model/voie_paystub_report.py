...
class VOIEPaystubReport(
    ...
    class MetaOapg:
        ...
        class all_of_1(
                ...
                class properties:
                    ...
                    class payStatements(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['VOIEPaystubPayStatement']:
                                return VOIEPaystubPayStatement
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['VOIEPaystubPayStatement'], typing.List['VOIEPaystubPayStatement']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'payStatements':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'VOIEPaystubPayStatement':
                            return super().__getitem__(i)
                    __annotations__ = {
                        "assetIds": assetIds,
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["assetIds", "numberOfBillableAssets", "payStatements", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["assetIds", "numberOfBillableAssets", "payStatements", ], str]):
