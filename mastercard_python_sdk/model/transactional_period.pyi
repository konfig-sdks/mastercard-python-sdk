...
class TransactionalPeriod(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["count", "endDate", "startDate", "max", "mean", "median", "min", "standardDeviation", "sum", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["count", "endDate", "startDate", "max", "mean", "median", "min", "standardDeviation", "sum", ], str]):
