...
class TxPushSubscriptionParameters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["callbackUrl", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["callbackUrl", ], str]):
