...
class InitiatedMicroDeposit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            depositCount = schemas.Int32Schema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["depositCount"]) -> MetaOapg.properties.depositCount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountId", "status", "depositCount", "statusDescription", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["depositCount"]) -> typing.Union[MetaOapg.properties.depositCount, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountId", "status", "depositCount", "statusDescription", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        depositCount: typing.Union[MetaOapg.properties.depositCount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
