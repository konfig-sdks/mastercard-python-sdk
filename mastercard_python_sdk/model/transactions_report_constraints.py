...
class TransactionsReportConstraints(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountIds", "fromDate", "reportCustomFields", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountIds", "fromDate", "reportCustomFields", ], str]):
