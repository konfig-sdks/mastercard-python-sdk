...
class PaystubTxVerifyMonthlyIncomeRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["estimatedMonthlyBasePay", "estimatedMonthlyOvertimePay", "estimatedMonthlyBonusPay", "estimatedMonthlyCommissionPay", "estimatedMonthlyOtherPay", "estimatedMonthlyTotalPay", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["estimatedMonthlyTotalPay"]) -> typing.Union[MetaOapg.properties.estimatedMonthlyTotalPay, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["estimatedMonthlyBasePay", "estimatedMonthlyOvertimePay", "estimatedMonthlyBonusPay", "estimatedMonthlyCommissionPay", "estimatedMonthlyOtherPay", "estimatedMonthlyTotalPay", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        estimatedMonthlyTotalPay: typing.Union[MetaOapg.properties.estimatedMonthlyTotalPay, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
