...
class SubscriptionRecord(
    ...
    signingKey: MetaOapg.properties.signingKey
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["signingKey"]) -> MetaOapg.properties.signingKey: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "accountId", "type", "callbackUrl", "signingKey", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["signingKey"]) -> MetaOapg.properties.signingKey: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "accountId", "type", "callbackUrl", "signingKey", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        signingKey: typing.Union[MetaOapg.properties.signingKey, str, ],
