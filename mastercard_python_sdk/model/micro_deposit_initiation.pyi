...
class MicroDepositInitiation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def receiver() -> typing.Type['Receiver']:
                return Receiver
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["receiver"]) -> 'Receiver': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["receiver", "institutionLoginId", "callbackUrl", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["receiver"]) -> 'Receiver': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["receiver", "institutionLoginId", "callbackUrl", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        receiver: 'Receiver',
        institutionLoginId: typing.Union[MetaOapg.properties.institutionLoginId, str, schemas.Unset] = schemas.unset,
