...
class BalanceAnalyticsAccountResult(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountDetails", "accountId", "currentReportRequest", "historicDataAvailability", "balanceAnalyticsMetrics", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountDetails", "accountId", "currentReportRequest", "historicDataAvailability", "balanceAnalyticsMetrics", ], str]):
