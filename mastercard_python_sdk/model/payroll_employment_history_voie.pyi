...
class PayrollEmploymentHistoryVOIE(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def income() -> typing.Type['PayrollVOIEIncomeRecord']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["income"]) -> 'PayrollVOIEIncomeRecord': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asOfDate", "employerName", "payrollSource", "employee", "employment", "income", "employmentId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["income"]) -> 'PayrollVOIEIncomeRecord': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asOfDate", "employerName", "payrollSource", "employee", "employment", "income", "employmentId", ], str]):
