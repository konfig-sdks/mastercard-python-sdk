...
class VOIReport(
    ...
    class MetaOapg:
        ...
        class all_of_1(
                ...
                class properties:
                    ...
                    class income(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['ReportIncomeStreamSummary']:
                                return ReportIncomeStreamSummary
                    
                        def __new__(
                            cls,
                            arg: typing.Union[typing.Tuple['ReportIncomeStreamSummary'], typing.List['ReportIncomeStreamSummary']],
                            _configuration: typing.Optional[schemas.Configuration] = None,
                        ) -> 'income':
                            return super().__new__(
                                cls,
                        ...
                        def __getitem__(self, i: int) -> 'ReportIncomeStreamSummary':
                            return super().__getitem__(i)
                    __annotations__ = {
                        "startDate": startDate,
                        "endDate": endDate,
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["startDate", "endDate", "days", "seasoned", "institutions", "income", ], str]):
            ...
            @typing.overload
            def get_item_oapg(self, name: typing_extensions.Literal["income"]) -> typing.Union[MetaOapg.properties.income, schemas.Unset]: ...
            
            @typing.overload
            def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
            
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startDate", "endDate", "days", "seasoned", "institutions", "income", ], str]):
            ...
            def __new__(
                ...
                *args: typing.Union[dict, frozendict.frozendict, ],
                ...
                income: typing.Union[MetaOapg.properties.income, list, tuple, schemas.Unset] = schemas.unset,
                _configuration: typing.Optional[schemas.Configuration] = None,
