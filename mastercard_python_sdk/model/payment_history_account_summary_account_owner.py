...
class PaymentHistoryAccountSummaryAccountOwner(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "address", "city", "state", "zip", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "address", "city", "state", "zip", ], str]):
