...
class LiteConnectParameters(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["partnerId", "customerId", "institutionId", "language", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "experience", "singleUseUrl", "isWebView", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["partnerId", "customerId", "institutionId", "language", "redirectUri", "webhook", "webhookContentType", "webhookData", "webhookHeaders", "experience", "singleUseUrl", "isWebView", ], str]):
