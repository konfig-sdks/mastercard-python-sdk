...
from mastercard_python_sdk.pydantic.analytics_report_data import AnalyticsReportData
...
class AnalyticsReportConstraintsOut(BaseModel):
    analytics_report_data: typing.Optional[AnalyticsReportData] = Field(None, alias='analyticsReportData')
