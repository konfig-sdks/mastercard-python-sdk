...
from mastercard_python_sdk.pydantic.voie_with_interview_data import VOIEWithInterviewData

class VOIEWithTXVerifyReportConstraintsOut(BaseModel):
    voie_with_interview_data: VOIEWithInterviewData = Field(alias='voieWithInterviewData')
