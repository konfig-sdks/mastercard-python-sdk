...
VOETransactionsReport = typing.Union[BaseReportAckWithPortfolioId,typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]
VOETransactionsReport = object
