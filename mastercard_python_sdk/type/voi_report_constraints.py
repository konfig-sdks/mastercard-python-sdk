...
class RequiredVOIReportConstraints(TypedDict):
    pass

class OptionalVOIReportConstraints(TypedDict, total=False):
...
class VOIReportConstraints(RequiredVOIReportConstraints, OptionalVOIReportConstraints):
    pass
