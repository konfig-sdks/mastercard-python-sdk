...
from mastercard_python_sdk.type.state_period import StatePeriod

class RequiredStateTimeInterval(TypedDict):
    # Periods of the specified time interval type, describing the attribute calculations
    periods: typing.List[StatePeriod]
...
class OptionalStateTimeInterval(TypedDict, total=False):
    pass

class StateTimeInterval(RequiredStateTimeInterval, OptionalStateTimeInterval):
    pass
