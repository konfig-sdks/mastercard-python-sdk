...
class RequiredConnectEmailParameters(TypedDict):
...
class OptionalConnectEmailParameters(TypedDict, total=False):
...
class ConnectEmailParameters(RequiredConnectEmailParameters, OptionalConnectEmailParameters):
    pass
