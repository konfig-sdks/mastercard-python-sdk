...
from mastercard_python_sdk.type.cash_flow_cash_flow_balance import CashFlowCashFlowBalance
from mastercard_python_sdk.type.cash_flow_cash_flow_characteristic import CashFlowCashFlowCharacteristic
from mastercard_python_sdk.type.cash_flow_cash_flow_credit import CashFlowCashFlowCredit
from mastercard_python_sdk.type.cash_flow_cash_flow_debit import CashFlowCashFlowDebit
from mastercard_python_sdk.type.report_transaction import ReportTransaction

class RequiredCashFlowReportAccount(TypedDict):
    pass

class OptionalCashFlowReportAccount(TypedDict, total=False):
    # Finicity account ID
    id: int
...
class CashFlowReportAccount(RequiredCashFlowReportAccount, OptionalCashFlowReportAccount):
    pass
