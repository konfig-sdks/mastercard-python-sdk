...
class RequiredVOAWithIncomeReportConstraints(TypedDict):
    pass

class OptionalVOAWithIncomeReportConstraints(TypedDict, total=False):
...
class VOAWithIncomeReportConstraints(RequiredVOAWithIncomeReportConstraints, OptionalVOAWithIncomeReportConstraints):
    pass
