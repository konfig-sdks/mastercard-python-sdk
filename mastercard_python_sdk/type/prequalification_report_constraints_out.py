...
class RequiredPrequalificationReportConstraintsOut(TypedDict):
    pass

class OptionalPrequalificationReportConstraintsOut(TypedDict, total=False):
...
class PrequalificationReportConstraintsOut(RequiredPrequalificationReportConstraintsOut, OptionalPrequalificationReportConstraintsOut):
    pass
