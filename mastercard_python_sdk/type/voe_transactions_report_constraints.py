...
class RequiredVOETransactionsReportConstraints(TypedDict):
    pass

class OptionalVOETransactionsReportConstraints(TypedDict, total=False):
    # A report ID
    reportId: str
...
class VOETransactionsReportConstraints(RequiredVOETransactionsReportConstraints, OptionalVOETransactionsReportConstraints):
    pass
