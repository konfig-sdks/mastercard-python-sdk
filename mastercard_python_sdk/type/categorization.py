...
class OptionalCategorization(TypedDict, total=False):
    # City
    city: str
    ...
    bestRepresentation: str

class Categorization(RequiredCategorization, OptionalCategorization):
    pass
