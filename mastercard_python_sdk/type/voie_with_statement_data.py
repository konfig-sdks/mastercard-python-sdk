...
class RequiredVOIEWithStatementData(TypedDict):
    # A list of pay statement asset IDs
    assetIds: typing.List[str]

class OptionalVOIEWithStatementData(TypedDict, total=False):
...
class VOIEWithStatementData(RequiredVOIEWithStatementData, OptionalVOIEWithStatementData):
    pass
