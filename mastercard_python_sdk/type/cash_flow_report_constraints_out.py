...
class RequiredCashFlowReportConstraintsOut(TypedDict):
    pass

class OptionalCashFlowReportConstraintsOut(TypedDict, total=False):
...
class CashFlowReportConstraintsOut(RequiredCashFlowReportConstraintsOut, OptionalCashFlowReportConstraintsOut):
    pass
