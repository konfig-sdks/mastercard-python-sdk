...
class RequiredLiteConnectParameters(TypedDict):
...
class OptionalLiteConnectParameters(TypedDict, total=False):
...
class LiteConnectParameters(RequiredLiteConnectParameters, OptionalLiteConnectParameters):
    pass
