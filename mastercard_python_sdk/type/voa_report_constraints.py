...
class RequiredVOAReportConstraints(TypedDict):
    pass

class OptionalVOAReportConstraints(TypedDict, total=False):
...
class VOAReportConstraints(RequiredVOAReportConstraints, OptionalVOAReportConstraints):
    pass
