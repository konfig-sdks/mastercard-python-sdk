...
class RequiredCashFlowMonthlyCashFlowCredits(TypedDict):
...
class OptionalCashFlowMonthlyCashFlowCredits(TypedDict, total=False):
    pass

class CashFlowMonthlyCashFlowCredits(RequiredCashFlowMonthlyCashFlowCredits, OptionalCashFlowMonthlyCashFlowCredits):
    pass
