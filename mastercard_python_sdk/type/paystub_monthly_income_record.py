...
class RequiredPaystubMonthlyIncomeRecord(TypedDict):
    pass

class OptionalPaystubMonthlyIncomeRecord(TypedDict, total=False):
...
class PaystubMonthlyIncomeRecord(RequiredPaystubMonthlyIncomeRecord, OptionalPaystubMonthlyIncomeRecord):
    pass
