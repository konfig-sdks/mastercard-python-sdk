...
class RequiredVOIReportIncomeStream(TypedDict):
    # Income stream ID
    id: str
...
class OptionalVOIReportIncomeStream(TypedDict, total=False):
...
class VOIReportIncomeStream(RequiredVOIReportIncomeStream, OptionalVOIReportIncomeStream):
    pass
