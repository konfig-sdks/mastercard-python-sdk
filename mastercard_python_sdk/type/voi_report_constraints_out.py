...
class RequiredVOIReportConstraintsOut(TypedDict):
    pass

class OptionalVOIReportConstraintsOut(TypedDict, total=False):
...
class VOIReportConstraintsOut(RequiredVOIReportConstraintsOut, OptionalVOIReportConstraintsOut):
    pass
