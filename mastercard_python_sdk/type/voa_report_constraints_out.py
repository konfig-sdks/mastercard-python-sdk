...
class RequiredVOAReportConstraintsOut(TypedDict):
    pass

class OptionalVOAReportConstraintsOut(TypedDict, total=False):
...
class VOAReportConstraintsOut(RequiredVOAReportConstraintsOut, OptionalVOAReportConstraintsOut):
    pass
