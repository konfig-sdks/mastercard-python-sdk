...
class RequiredVOAIReportIncomeStream(TypedDict):
    # Income stream ID
    id: str
...
class OptionalVOAIReportIncomeStream(TypedDict, total=False):
...
class VOAIReportIncomeStream(RequiredVOAIReportIncomeStream, OptionalVOAIReportIncomeStream):
    pass
