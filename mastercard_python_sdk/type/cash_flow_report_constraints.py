...
class RequiredCashFlowReportConstraints(TypedDict):
    pass

class OptionalCashFlowReportConstraints(TypedDict, total=False):
...
class CashFlowReportConstraints(RequiredCashFlowReportConstraints, OptionalCashFlowReportConstraints):
    pass
