...
class RequiredAnalyticsReportConstraintsOut(TypedDict):
    pass

class OptionalAnalyticsReportConstraintsOut(TypedDict, total=False):
...
class AnalyticsReportConstraintsOut(RequiredAnalyticsReportConstraintsOut, OptionalAnalyticsReportConstraintsOut):
    pass
