...
class RequiredPayrollEmployeeAddress(TypedDict):
    pass

class OptionalPayrollEmployeeAddress(TypedDict, total=False):
...
class PayrollEmployeeAddress(RequiredPayrollEmployeeAddress, OptionalPayrollEmployeeAddress):
    pass
