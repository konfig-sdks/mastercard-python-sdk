...
class RequiredVOETransactionsReportConstraintsOut(TypedDict):
    pass

class OptionalVOETransactionsReportConstraintsOut(TypedDict, total=False):
    # A report ID
    reportId: str
...
class VOETransactionsReportConstraintsOut(RequiredVOETransactionsReportConstraintsOut, OptionalVOETransactionsReportConstraintsOut):
    pass
