...
class RequiredThirdPartyAccessPeriod(TypedDict):
...
class OptionalThirdPartyAccessPeriod(TypedDict, total=False):
    pass

class ThirdPartyAccessPeriod(RequiredThirdPartyAccessPeriod, OptionalThirdPartyAccessPeriod):
    pass
