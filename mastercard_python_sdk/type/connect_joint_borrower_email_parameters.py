...
class RequiredConnectJointBorrowerEmailParameters(TypedDict):
...
class OptionalConnectJointBorrowerEmailParameters(TypedDict, total=False):
...
class ConnectJointBorrowerEmailParameters(RequiredConnectJointBorrowerEmailParameters, OptionalConnectJointBorrowerEmailParameters):
    pass
