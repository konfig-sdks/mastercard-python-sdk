...
class RequiredCashFlowMonthlyCashFlowDebitSummaries(TypedDict):
...
class OptionalCashFlowMonthlyCashFlowDebitSummaries(TypedDict, total=False):
    pass

class CashFlowMonthlyCashFlowDebitSummaries(RequiredCashFlowMonthlyCashFlowDebitSummaries, OptionalCashFlowMonthlyCashFlowDebitSummaries):
    pass
