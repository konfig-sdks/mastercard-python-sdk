...
class RequiredConnectJointBorrowerParameters(TypedDict):
    # Your Partner ID displayed in the [Developer Dashboard](https://developer.mastercard.com/account/log-in)
    partnerId: str

    borrowers: Borrowers

class OptionalConnectJointBorrowerParameters(TypedDict, total=False):
...
class ConnectJointBorrowerParameters(RequiredConnectJointBorrowerParameters, OptionalConnectJointBorrowerParameters):
    pass
