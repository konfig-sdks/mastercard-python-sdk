...
class RequiredTransactionsReportConstraintsOut(TypedDict):
    pass

class OptionalTransactionsReportConstraintsOut(TypedDict, total=False):
...
class TransactionsReportConstraintsOut(RequiredTransactionsReportConstraintsOut, OptionalTransactionsReportConstraintsOut):
    pass
