...
from mastercard_python_sdk.exceptions_base import ApiValueError
from mastercard_python_sdk.exceptions import ClientConfigurationError
...
conf = mastercard_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.finicity.com" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if finicity_app_key:
            self.api_key['FinicityAppKey'] = finicity_app_key
        else:
            raise ClientConfigurationError('API Key "FinicityAppKey" is required')
        if finicity_app_token:
            self.api_key['FinicityAppToken'] = finicity_app_token
        else:
            raise ClientConfigurationError('API Key "FinicityAppToken" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("mastercard_python_sdk")
