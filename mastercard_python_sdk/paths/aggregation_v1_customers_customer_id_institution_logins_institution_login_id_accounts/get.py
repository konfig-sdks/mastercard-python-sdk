...
class BaseApi(api_client.Api):
    ...
    def _get_by_institution_login_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aget_by_institution_login_oapg(
        self,
    ...
    def _get_by_institution_login_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByInstitutionLoginRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_institution_login(
        self,
        customer_id: str,
        institution_login_id: str,
        **kwargs,
        ...
        args = self._get_by_institution_login_mapped_args(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
        return await self._aget_by_institution_login_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_institution_login(
        self,
        customer_id: str,
        institution_login_id: str,
    ) -> typing.Union[
        ...
        return self._get_by_institution_login_oapg(
            path_params=args.path,
        )

class GetByInstitutionLogin(BaseApi):
    ...
    async def aget_by_institution_login(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_institution_login(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
            **kwargs,
        )
    ...
    def get_by_institution_login(
        ...
        raw_response = self.raw.get_by_institution_login(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
        if validate:
