...
class BaseApi(api_client.Api):
    ...
    def _get_binary_file_mapped_args(
        self,
        customer_id: str,
        asset_id: str,
    ...
    async def _aget_binary_file_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/assets/{assetId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBinaryFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_binary_file(
        self,
        customer_id: str,
        asset_id: str,
        **kwargs,
        ...
        args = self._get_binary_file_mapped_args(
            customer_id=customer_id,
            asset_id=asset_id,
        )
        return await self._aget_binary_file_oapg(
    ...
    def get_binary_file(
        ...
        return self._get_binary_file_oapg(
            path_params=args.path,
        )

class GetBinaryFile(BaseApi):
    ...
    async def aget_binary_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_binary_file(
            customer_id=customer_id,
            asset_id=asset_id,
            **kwargs,
        )
    ...
    def get_binary_file(
        ...
        raw_response = self.raw.get_binary_file(
            customer_id=customer_id,
            asset_id=asset_id,
        )
        if validate:
