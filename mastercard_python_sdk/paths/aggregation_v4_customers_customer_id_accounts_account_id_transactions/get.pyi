...
from mastercard_python_sdk.model.transactions import Transactions as TransactionsSchema
from mastercard_python_sdk.model.error_message import ErrorMessage as ErrorMessageSchema

from mastercard_python_sdk.type.transactions import Transactions
...
from mastercard_python_sdk.pydantic.transactions import Transactions as TransactionsPydantic

# Query params
FromDateSchema = schemas.Int64Schema
...
SchemaFor200ResponseBodyApplicationJson = TransactionsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_customer_account_transactions_mapped_args(
        self,
        customer_id: str,
        account_id: str,
        from_date: int,
    ...
    async def _aget_customer_account_transactions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v4/customers/{customerId}/accounts/{accountId}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_customer_account_transactions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCustomerAccountTransactionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_customer_account_transactions(
        self,
        customer_id: str,
        account_id: str,
        from_date: int,
        ...
        **kwargs,
        ...
        args = self._get_customer_account_transactions_mapped_args(
        ...
        return await self._aget_customer_account_transactions_oapg(
    ...
    def get_customer_account_transactions(
        ...
        return self._get_customer_account_transactions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCustomerAccountTransactions(BaseApi):
    ...
    async def aget_customer_account_transactions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionsPydantic:
        raw_response = await self.raw.aget_customer_account_transactions(
            customer_id=customer_id,
            account_id=account_id,
            from_date=from_date,
            to_date=to_date,
        ...
        if validate:
            return TransactionsPydantic(**raw_response.body)
        return api_client.construct_model_instance(TransactionsPydantic, raw_response.body)
    ...
    def get_customer_account_transactions(
        ...
        raw_response = self.raw.get_customer_account_transactions(
            customer_id=customer_id,
            account_id=account_id,
            from_date=from_date,
            to_date=to_date,
