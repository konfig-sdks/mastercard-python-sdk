...
class BaseApi(api_client.Api):
    ...
    def _get_certified_institutions_with_rssd_mapped_args(
        self,
    ...
    async def _aget_certified_institutions_with_rssd_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/institution/v2/certifiedInstitutions/rssd',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_certified_institutions_with_rssd_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCertifiedInstitutionsWithRssdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_certified_institutions_with_rssd(
        self,
        search: typing.Optional[str] = None,
        start: typing.Optional[int] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_certified_institutions_with_rssd_mapped_args(
            search=search,
            start=start,
            limit=limit,
            type=type,
        ...
        return await self._aget_certified_institutions_with_rssd_oapg(
    ...
    def get_certified_institutions_with_rssd(
        ...
        return self._get_certified_institutions_with_rssd_oapg(
            query_params=args.query,
        )

class GetCertifiedInstitutionsWithRssd(BaseApi):
    ...
    async def aget_certified_institutions_with_rssd(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_certified_institutions_with_rssd(
            search=search,
            start=start,
            limit=limit,
            type=type,
    ...
    def get_certified_institutions_with_rssd(
        ...
        raw_response = self.raw.get_certified_institutions_with_rssd(
            search=search,
            start=start,
            limit=limit,
            type=type,
