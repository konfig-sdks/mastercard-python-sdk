...
class BaseApi(api_client.Api):
    ...
    def _get_customer_statement_in_pdf_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _aget_customer_statement_in_pdf_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts/{accountId}/statement',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_customer_statement_in_pdf_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCustomerStatementInPdfRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_customer_statement_in_pdf(
        self,
        customer_id: str,
        account_id: str,
        index: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_customer_statement_in_pdf_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
            index=index,
            type=type,
        )
        return await self._aget_customer_statement_in_pdf_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_customer_statement_in_pdf(
        self,
        customer_id: str,
        account_id: str,
        index: typing.Optional[int] = None,
        ...
        return self._get_customer_statement_in_pdf_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCustomerStatementInPdf(BaseApi):
    ...
    async def aget_customer_statement_in_pdf(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_customer_statement_in_pdf(
            customer_id=customer_id,
            account_id=account_id,
            index=index,
            type=type,
    ...
    def get_customer_statement_in_pdf(
        ...
        raw_response = self.raw.get_customer_statement_in_pdf(
            customer_id=customer_id,
            account_id=account_id,
            index=index,
            type=type,
