...
from mastercard_python_sdk.model.connect_parameters import ConnectParameters as ConnectParametersSchema
...
from mastercard_python_sdk.type.connect_parameters import ConnectParameters
...
from mastercard_python_sdk.pydantic.connect_parameters import ConnectParameters as ConnectParametersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ConnectParametersSchema


request_body_connect_parameters = api_client.RequestBody(
    content={
    ...
    async def _agenerate_url_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connect/v2/generate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_connect_parameters.serialize(body, content_type)
...
class GenerateUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_url(
        self,
        partner_id: str,
        customer_id: str,
        language: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._generate_url_mapped_args(
        ...
        return await self._agenerate_url_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def generate_url(
        ...
        return self._generate_url_oapg(
            body=args.body,
        )

class GenerateUrl(BaseApi):
    ...
    async def agenerate_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_url(
            partner_id=partner_id,
            customer_id=customer_id,
            language=language,
            consumer_id=consumer_id,
    ...
    def generate_url(
        ...
        raw_response = self.raw.generate_url(
            partner_id=partner_id,
            customer_id=customer_id,
            language=language,
            consumer_id=consumer_id,
