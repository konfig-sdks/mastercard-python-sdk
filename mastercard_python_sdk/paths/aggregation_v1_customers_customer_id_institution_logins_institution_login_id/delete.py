...
class BaseApi(api_client.Api):
    ...
    def _remove_by_institution_login_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aremove_by_institution_login_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/institutionLogins/{institutionLoginId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_by_institution_login_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveByInstitutionLoginRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_institution_login(
        self,
        customer_id: str,
        institution_login_id: str,
        **kwargs,
        ...
        args = self._remove_by_institution_login_mapped_args(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
        return await self._aremove_by_institution_login_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_institution_login(
        self,
        customer_id: str,
        institution_login_id: str,
    ) -> typing.Union[
        ...
        return self._remove_by_institution_login_oapg(
            path_params=args.path,
        )

class RemoveByInstitutionLogin(BaseApi):
    ...
    async def aremove_by_institution_login(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_institution_login(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
            **kwargs,
        )
    ...
    def remove_by_institution_login(
        ...
        raw_response = self.raw.remove_by_institution_login(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
