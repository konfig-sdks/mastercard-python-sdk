...
class BaseApi(api_client.Api):
    ...
    def _remove_by_customer_id_and_account_id_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _aremove_by_customer_id_and_account_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts/{accountId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _remove_by_customer_id_and_account_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveByCustomerIdAndAccountIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_by_customer_id_and_account_id(
        self,
        customer_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._remove_by_customer_id_and_account_id_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
        )
        return await self._aremove_by_customer_id_and_account_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_by_customer_id_and_account_id(
        self,
        customer_id: str,
        account_id: str,
    ) -> typing.Union[
        ...
        return self._remove_by_customer_id_and_account_id_oapg(
            path_params=args.path,
        )

class RemoveByCustomerIdAndAccountId(BaseApi):
    ...
    async def aremove_by_customer_id_and_account_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_by_customer_id_and_account_id(
            customer_id=customer_id,
            account_id=account_id,
            **kwargs,
        )
    ...
    def remove_by_customer_id_and_account_id(
        ...
        raw_response = self.raw.remove_by_customer_id_and_account_id(
            customer_id=customer_id,
            account_id=account_id,
        )
