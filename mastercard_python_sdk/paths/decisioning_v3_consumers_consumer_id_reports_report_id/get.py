...
class BaseApi(api_client.Api):
    ...
    def _get_by_consumer_and_id_mapped_args(
        self,
        consumer_id: str,
        report_id: str,
    ...
    async def _aget_by_consumer_and_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v3/consumers/{consumerId}/reports/{reportId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_by_consumer_and_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetByConsumerAndIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_consumer_and_id(
        self,
        consumer_id: str,
        report_id: str,
        purpose: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_consumer_and_id_mapped_args(
            consumer_id=consumer_id,
            report_id=report_id,
            purpose=purpose,
            on_behalf_of=on_behalf_of,
        )
        return await self._aget_by_consumer_and_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_consumer_and_id(
        self,
        consumer_id: str,
        report_id: str,
        purpose: typing.Optional[str] = None,
        ...
        return self._get_by_consumer_and_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByConsumerAndId(BaseApi):
    ...
    async def aget_by_consumer_and_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_consumer_and_id(
            consumer_id=consumer_id,
            report_id=report_id,
            purpose=purpose,
            on_behalf_of=on_behalf_of,
    ...
    def get_by_consumer_and_id(
        ...
        raw_response = self.raw.get_by_consumer_and_id(
            consumer_id=consumer_id,
            report_id=report_id,
            purpose=purpose,
            on_behalf_of=on_behalf_of,
