...
from mastercard_python_sdk.model.account_owner import AccountOwner as AccountOwnerSchema

from mastercard_python_sdk.type.account_owner import AccountOwner
...
from mastercard_python_sdk.pydantic.account_owner import AccountOwner as AccountOwnerPydantic
...
SchemaFor200ResponseBodyApplicationJson = AccountOwnerSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_account_owner_details_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _aget_account_owner_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts/{accountId}/owner',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_account_owner_details_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAccountOwnerDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_account_owner_details(
        self,
        customer_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._get_account_owner_details_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
        )
        return await self._aget_account_owner_details_oapg(
    ...
    def get_account_owner_details(
        ...
        return self._get_account_owner_details_oapg(
            path_params=args.path,
        )

class GetAccountOwnerDetails(BaseApi):
    ...
    async def aget_account_owner_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AccountOwnerPydantic:
        raw_response = await self.raw.aget_account_owner_details(
            customer_id=customer_id,
            account_id=account_id,
            **kwargs,
        )
        if validate:
            return AccountOwnerPydantic(**raw_response.body)
        return api_client.construct_model_instance(AccountOwnerPydantic, raw_response.body)
    ...
    def get_account_owner_details(
        ...
        raw_response = self.raw.get_account_owner_details(
            customer_id=customer_id,
            account_id=account_id,
        )
        if validate:
