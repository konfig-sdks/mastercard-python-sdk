...
class BaseApi(api_client.Api):
    ...
    def _generate_customer_payment_report_mapped_args(
        self,
        customer_id: str,
    ...
    async def _agenerate_customer_payment_report_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/analytics/payment-history/v1/customer/{customerId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _generate_customer_payment_report_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GenerateCustomerPaymentReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_customer_payment_report(
        self,
        customer_id: str,
        reference_number: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._generate_customer_payment_report_mapped_args(
            customer_id=customer_id,
            reference_number=reference_number,
        )
        return await self._agenerate_customer_payment_report_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def generate_customer_payment_report(
        self,
        customer_id: str,
        reference_number: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._generate_customer_payment_report_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GenerateCustomerPaymentReport(BaseApi):
    ...
    async def agenerate_customer_payment_report(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_customer_payment_report(
            customer_id=customer_id,
            reference_number=reference_number,
            **kwargs,
        )
    ...
    def generate_customer_payment_report(
        ...
        raw_response = self.raw.generate_customer_payment_report(
            customer_id=customer_id,
            reference_number=reference_number,
        )
        if validate:
