...
from mastercard_python_sdk.model.connect_email_parameters import ConnectEmailParameters as ConnectEmailParametersSchema
from mastercard_python_sdk.model.connect_email_url import ConnectEmailUrl as ConnectEmailUrlSchema
from mastercard_python_sdk.model.error_message import ErrorMessage as ErrorMessageSchema
from mastercard_python_sdk.model.email_options import EmailOptions as EmailOptionsSchema
from mastercard_python_sdk.model.consumer_info import ConsumerInfo as ConsumerInfoSchema
from mastercard_python_sdk.model.report_custom_fields import ReportCustomFields as ReportCustomFieldsSchema

from mastercard_python_sdk.type.connect_email_url import ConnectEmailUrl
from mastercard_python_sdk.type.connect_email_parameters import ConnectEmailParameters
from mastercard_python_sdk.type.email_options import EmailOptions
...
from mastercard_python_sdk.pydantic.email_options import EmailOptions as EmailOptionsPydantic
from mastercard_python_sdk.pydantic.error_message import ErrorMessage as ErrorMessagePydantic
from mastercard_python_sdk.pydantic.consumer_info import ConsumerInfo as ConsumerInfoPydantic
from mastercard_python_sdk.pydantic.connect_email_parameters import ConnectEmailParameters as ConnectEmailParametersPydantic
from mastercard_python_sdk.pydantic.connect_email_url import ConnectEmailUrl as ConnectEmailUrlPydantic

# body param
SchemaForRequestBodyApplicationJson = ConnectEmailParametersSchema


request_body_connect_email_parameters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ConnectEmailUrlSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ConnectEmailUrl
...
class BaseApi(api_client.Api):
    ...
    def _send_connect_email_mapped_args(
        self,
        partner_id: str,
        customer_id: str,
        consumer_id: str,
        ...
        optional_consumer_info: typing.Optional[ConsumerInfo] = None,
        ...
        if optional_consumer_info is not None:
            _body["optionalConsumerInfo"] = optional_consumer_info
        args.body = _body
        return args

    async def _asend_connect_email_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connect/v2/send/email',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_connect_email_parameters.serialize(body, content_type)
...
class SendConnectEmailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_connect_email(
        self,
        partner_id: str,
        customer_id: str,
        consumer_id: str,
        ...
        **kwargs,
        ...
        args = self._send_connect_email_mapped_args(
            ...
            optional_consumer_info=optional_consumer_info,
        )
        return await self._asend_connect_email_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def send_connect_email(
        ...
        return self._send_connect_email_oapg(
            body=args.body,
        )

class SendConnectEmail(BaseApi):
    ...
    async def asend_connect_email(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ConnectEmailUrlPydantic:
        raw_response = await self.raw.asend_connect_email(
            partner_id=partner_id,
            customer_id=customer_id,
            consumer_id=consumer_id,
            email=email,
        ...
        if validate:
            return ConnectEmailUrlPydantic(**raw_response.body)
        return api_client.construct_model_instance(ConnectEmailUrlPydantic, raw_response.body)
    ...
    def send_connect_email(
        ...
        raw_response = self.raw.send_connect_email(
            partner_id=partner_id,
            customer_id=customer_id,
            consumer_id=consumer_id,
            email=email,
