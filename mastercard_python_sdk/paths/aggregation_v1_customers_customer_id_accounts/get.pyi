...
class BaseApi(api_client.Api):
    ...
    def _get_customer_accounts_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aget_customer_accounts_oapg(
        self,
    ...
    def _get_customer_accounts_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCustomerAccountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_customer_accounts(
        self,
        customer_id: str,
        status: typing.Optional[str] = None,
        account_type: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_customer_accounts_mapped_args(
            customer_id=customer_id,
            status=status,
            account_type=account_type,
        )
        return await self._aget_customer_accounts_oapg(
    ...
    def get_customer_accounts(
        ...
        return self._get_customer_accounts_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCustomerAccounts(BaseApi):
    ...
    async def aget_customer_accounts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_customer_accounts(
            customer_id=customer_id,
            status=status,
            account_type=account_type,
            **kwargs,
    ...
    def get_customer_accounts(
        ...
        raw_response = self.raw.get_customer_accounts(
            customer_id=customer_id,
            status=status,
            account_type=account_type,
        )
