...
class BaseApi(api_client.Api):
    ...
    def _refresh_customer_aggregation_mapped_args(
        self,
        customer_id: str,
    ...
    async def _arefresh_customer_aggregation_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _refresh_customer_aggregation_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RefreshCustomerAggregationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arefresh_customer_aggregation(
        self,
        customer_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._refresh_customer_aggregation_mapped_args(
            customer_id=customer_id,
        )
        return await self._arefresh_customer_aggregation_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def refresh_customer_aggregation(
        self,
        customer_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._refresh_customer_aggregation_oapg(
            path_params=args.path,
        )

class RefreshCustomerAggregation(BaseApi):
    ...
    async def arefresh_customer_aggregation(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arefresh_customer_aggregation(
            customer_id=customer_id,
            **kwargs,
        )
        if validate:
    ...
    def refresh_customer_aggregation(
        ...
        raw_response = self.raw.refresh_customer_aggregation(
            customer_id=customer_id,
        )
        if validate:
            return CustomerAccountsPydantic(**raw_response.body)
