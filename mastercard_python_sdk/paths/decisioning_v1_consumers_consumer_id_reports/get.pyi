...
class BaseApi(api_client.Api):
    ...
    def _by_consumer_id_mapped_args(
        self,
        consumer_id: str,
    ...
    async def _aby_consumer_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v1/consumers/{consumerId}/reports',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ByConsumerIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aby_consumer_id(
        self,
        consumer_id: str,
        purpose: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._by_consumer_id_mapped_args(
            consumer_id=consumer_id,
            purpose=purpose,
        )
        return await self._aby_consumer_id_oapg(
    ...
    def by_consumer_id(
        ...
        return self._by_consumer_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ByConsumerId(BaseApi):
    ...
    async def aby_consumer_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aby_consumer_id(
            consumer_id=consumer_id,
            purpose=purpose,
            **kwargs,
        )
    ...
    def by_consumer_id(
        ...
        raw_response = self.raw.by_consumer_id(
            consumer_id=consumer_id,
            purpose=purpose,
        )
        if validate:
