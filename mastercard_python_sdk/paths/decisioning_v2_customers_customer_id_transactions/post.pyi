...
from mastercard_python_sdk.model.transactions_report_ack import TransactionsReportAck as TransactionsReportAckSchema
from mastercard_python_sdk.model.error_message import ErrorMessage as ErrorMessageSchema
from mastercard_python_sdk.model.transactions_report_constraints import TransactionsReportConstraints as TransactionsReportConstraintsSchema
from mastercard_python_sdk.model.report_custom_fields import ReportCustomFields as ReportCustomFieldsSchema

from mastercard_python_sdk.type.transactions_report_constraints import TransactionsReportConstraints
from mastercard_python_sdk.type.transactions_report_ack import TransactionsReportAck
...
from mastercard_python_sdk.pydantic.transactions_report_ack import TransactionsReportAck as TransactionsReportAckPydantic
from mastercard_python_sdk.pydantic.transactions_report_constraints import TransactionsReportConstraints as TransactionsReportConstraintsPydantic
...
ToDateSchema = schemas.Int64Schema
...
# body param
SchemaForRequestBodyApplicationJson = TransactionsReportConstraintsSchema


request_body_transactions_report_constraints = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = TransactionsReportAckSchema


@dataclass
class ApiResponseFor202(api_client.ApiResponse):
    body: TransactionsReportAck
...
class BaseApi(api_client.Api):
    ...
    def _get24_months_history_and_generate_report_mapped_args(
        self,
        customer_id: str,
        to_date: int,
    ...
    async def _aget24_months_history_and_generate_report_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v2/customers/{customerId}/transactions',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_transactions_report_constraints.serialize(body, content_type)
    ...
    def _get24_months_history_and_generate_report_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class Get24MonthsHistoryAndGenerateReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget24_months_history_and_generate_report(
        self,
        customer_id: str,
        to_date: int,
        account_ids: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get24_months_history_and_generate_report_mapped_args(
        ...
        return await self._aget24_months_history_and_generate_report_oapg(
            body=args.body,
    ...
    def get24_months_history_and_generate_report(
        self,
        customer_id: str,
        to_date: int,
        account_ids: typing.Optional[str] = None,
        ...
        return self._get24_months_history_and_generate_report_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class Get24MonthsHistoryAndGenerateReport(BaseApi):
    ...
    async def aget24_months_history_and_generate_report(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TransactionsReportAckPydantic:
        raw_response = await self.raw.aget24_months_history_and_generate_report(
            customer_id=customer_id,
            to_date=to_date,
            account_ids=account_ids,
            from_date=from_date,
        ...
        if validate:
            return RootModel[TransactionsReportAckPydantic](raw_response.body).root
        return api_client.construct_model_instance(TransactionsReportAckPydantic, raw_response.body)
    ...
    def get24_months_history_and_generate_report(
        ...
        raw_response = self.raw.get24_months_history_and_generate_report(
            customer_id=customer_id,
            to_date=to_date,
            account_ids=account_ids,
            from_date=from_date,
