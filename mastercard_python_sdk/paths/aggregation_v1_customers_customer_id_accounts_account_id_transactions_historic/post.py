...
class BaseApi(api_client.Api):
    ...
    def _load_historic_transactions_for_customer_account_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _aload_historic_transactions_for_customer_account_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts/{accountId}/transactions/historic',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _load_historic_transactions_for_customer_account_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class LoadHistoricTransactionsForCustomerAccountRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aload_historic_transactions_for_customer_account(
        self,
        customer_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._load_historic_transactions_for_customer_account_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
        )
        return await self._aload_historic_transactions_for_customer_account_oapg(
    ...
    def load_historic_transactions_for_customer_account(
        ...
        return self._load_historic_transactions_for_customer_account_oapg(
            path_params=args.path,
        )

class LoadHistoricTransactionsForCustomerAccount(BaseApi):
    ...
    async def aload_historic_transactions_for_customer_account(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aload_historic_transactions_for_customer_account(
            customer_id=customer_id,
            account_id=account_id,
            **kwargs,
        )
    ...
    def load_historic_transactions_for_customer_account(
        ...
        raw_response = self.raw.load_historic_transactions_for_customer_account(
            customer_id=customer_id,
            account_id=account_id,
        )
