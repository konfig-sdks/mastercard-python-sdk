...
from mastercard_python_sdk.model.voi_report_ack import VOIReportAck as VOIReportAckSchema
...
from mastercard_python_sdk.model.voi_report_constraints import VOIReportConstraints as VOIReportConstraintsSchema

from mastercard_python_sdk.type.voi_report_ack import VOIReportAck
from mastercard_python_sdk.type.voi_report_constraints import VOIReportConstraints
...
from mastercard_python_sdk.pydantic.voi_report_ack import VOIReportAck as VOIReportAckPydantic
from mastercard_python_sdk.pydantic.error_message import ErrorMessage as ErrorMessagePydantic
from mastercard_python_sdk.pydantic.voi_report_constraints import VOIReportConstraints as VOIReportConstraintsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VOIReportConstraintsSchema


request_body_voi_report_constraints = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = VOIReportAckSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_voi_report_mapped_args(
        self,
        customer_id: str,
    ...
    async def _acreate_voi_report_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v2/customers/{customerId}/voi',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_voi_report_constraints.serialize(body, content_type)
...
class CreateVoiReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_voi_report(
        self,
        customer_id: str,
        account_ids: typing.Optional[str] = None,
        report_custom_fields: typing.Optional[ReportCustomFields] = None,
        ...
        **kwargs,
        ...
        args = self._create_voi_report_mapped_args(
        ...
        return await self._acreate_voi_report_oapg(
            body=args.body,
    ...
    def create_voi_report(
        ...
        return self._create_voi_report_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateVoiReport(BaseApi):
    ...
    async def acreate_voi_report(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VOIReportAckPydantic:
        raw_response = await self.raw.acreate_voi_report(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            from_date=from_date,
        ...
        if validate:
            return RootModel[VOIReportAckPydantic](raw_response.body).root
        return api_client.construct_model_instance(VOIReportAckPydantic, raw_response.body)
    ...
    def create_voi_report(
        ...
        raw_response = self.raw.create_voi_report(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            from_date=from_date,
