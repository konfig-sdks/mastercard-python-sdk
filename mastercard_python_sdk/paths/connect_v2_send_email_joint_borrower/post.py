...
from mastercard_python_sdk.model.connect_joint_borrower_email_parameters import ConnectJointBorrowerEmailParameters as ConnectJointBorrowerEmailParametersSchema
...
from mastercard_python_sdk.type.connect_joint_borrower_email_parameters import ConnectJointBorrowerEmailParameters
...
from mastercard_python_sdk.pydantic.connect_joint_borrower_email_parameters import ConnectJointBorrowerEmailParameters as ConnectJointBorrowerEmailParametersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ConnectJointBorrowerEmailParametersSchema


request_body_connect_joint_borrower_email_parameters = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _send_email_joint_borrower_mapped_args(
        self,
        partner_id: str,
        borrowers: Borrowers,
        email: EmailOptions,
    ...
    async def _asend_email_joint_borrower_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connect/v2/send/email/jointBorrower',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_connect_joint_borrower_email_parameters.serialize(body, content_type)
    ...
    def _send_email_joint_borrower_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SendEmailJointBorrowerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_email_joint_borrower(
        self,
        partner_id: str,
        borrowers: Borrowers,
        email: EmailOptions,
        ...
        **kwargs,
        ...
        args = self._send_email_joint_borrower_mapped_args(
        ...
        return await self._asend_email_joint_borrower_oapg(
            body=args.body,
            **kwargs,
        )
    
    def send_email_joint_borrower(
        self,
        partner_id: str,
        borrowers: Borrowers,
        email: EmailOptions,
        ...
        return self._send_email_joint_borrower_oapg(
            body=args.body,
        )

class SendEmailJointBorrower(BaseApi):
    ...
    async def asend_email_joint_borrower(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asend_email_joint_borrower(
            partner_id=partner_id,
            borrowers=borrowers,
            email=email,
            experience=experience,
    ...
    def send_email_joint_borrower(
        ...
        raw_response = self.raw.send_email_joint_borrower(
            partner_id=partner_id,
            borrowers=borrowers,
            email=email,
            experience=experience,
