...
from mastercard_python_sdk.model.micro_entry_verify_request_parameter import MicroEntryVerifyRequestParameter as MicroEntryVerifyRequestParameterSchema

from mastercard_python_sdk.type.connect_url import ConnectUrl
from mastercard_python_sdk.type.micro_entry_verify_request_parameter import MicroEntryVerifyRequestParameter
...
from mastercard_python_sdk.pydantic.micro_entry_verify_request_parameter import MicroEntryVerifyRequestParameter as MicroEntryVerifyRequestParameterPydantic

# body param
SchemaForRequestBodyApplicationJson = MicroEntryVerifyRequestParameterSchema


request_body_micro_entry_verify_request_parameter = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _verify_micro_entry_microdeposits_mapped_args(
        self,
    ...
    async def _averify_micro_entry_microdeposits_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connect/v2/generate/microentry/verify',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_micro_entry_verify_request_parameter.serialize(body, content_type)
    ...
    def _verify_micro_entry_microdeposits_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class VerifyMicroEntryMicrodepositsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_micro_entry_microdeposits(
        self,
        partner_id: typing.Optional[str] = None,
        customer_id: typing.Optional[str] = None,
        redirect_uri: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._verify_micro_entry_microdeposits_mapped_args(
        ...
        return await self._averify_micro_entry_microdeposits_oapg(
            body=args.body,
            **kwargs,
        )
    
    def verify_micro_entry_microdeposits(
        self,
        partner_id: typing.Optional[str] = None,
        customer_id: typing.Optional[str] = None,
        redirect_uri: typing.Optional[str] = None,
        ...
        return self._verify_micro_entry_microdeposits_oapg(
            body=args.body,
        )

class VerifyMicroEntryMicrodeposits(BaseApi):
    ...
    async def averify_micro_entry_microdeposits(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_micro_entry_microdeposits(
            partner_id=partner_id,
            customer_id=customer_id,
            redirect_uri=redirect_uri,
            webhook=webhook,
    ...
    def verify_micro_entry_microdeposits(
        ...
        raw_response = self.raw.verify_micro_entry_microdeposits(
            partner_id=partner_id,
            customer_id=customer_id,
            redirect_uri=redirect_uri,
            webhook=webhook,
