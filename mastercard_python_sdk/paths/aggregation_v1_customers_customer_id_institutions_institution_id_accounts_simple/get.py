...
class BaseApi(api_client.Api):
    ...
    def _get_basic_info_mapped_args(
        self,
        customer_id: str,
        institution_id: int,
    ...
    async def _aget_basic_info_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/institutions/{institutionId}/accounts/simple',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBasicInfoRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_basic_info(
        self,
        customer_id: str,
        institution_id: int,
        **kwargs,
        ...
        args = self._get_basic_info_mapped_args(
            customer_id=customer_id,
            institution_id=institution_id,
        )
        return await self._aget_basic_info_oapg(
    ...
    def get_basic_info(
        ...
        return self._get_basic_info_oapg(
            path_params=args.path,
        )

class GetBasicInfo(BaseApi):
    ...
    async def aget_basic_info(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_basic_info(
            customer_id=customer_id,
            institution_id=institution_id,
            **kwargs,
        )
    ...
    def get_basic_info(
        ...
        raw_response = self.raw.get_basic_info(
            customer_id=customer_id,
            institution_id=institution_id,
        )
        if validate:
