...
from mastercard_python_sdk.model.ach_details import ACHDetails as ACHDetailsSchema

from mastercard_python_sdk.type.ach_details import ACHDetails
...
from mastercard_python_sdk.pydantic.ach_details import ACHDetails as ACHDetailsPydantic
...
SchemaFor200ResponseBodyApplicationJson = ACHDetailsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_ach_details_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _aget_ach_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/accounts/{accountId}/details',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAchDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_ach_details(
        self,
        customer_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._get_ach_details_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
        )
        return await self._aget_ach_details_oapg(
    ...
    def get_ach_details(
        ...
        return self._get_ach_details_oapg(
            path_params=args.path,
        )

class GetAchDetails(BaseApi):
    ...
    async def aget_ach_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_ach_details(
            customer_id=customer_id,
            account_id=account_id,
            **kwargs,
        )
        if validate:
            return ACHDetailsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ACHDetailsPydantic, raw_response.body)
    ...
    def get_ach_details(
        ...
        raw_response = self.raw.get_ach_details(
            customer_id=customer_id,
            account_id=account_id,
        )
        if validate:
