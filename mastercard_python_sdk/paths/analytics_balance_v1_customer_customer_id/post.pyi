...
class BaseApi(api_client.Api):
    ...
    def _generate_analytics_report_mapped_args(
        self,
        customer_id: str,
    ...
    async def _agenerate_analytics_report_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/analytics/balance/v1/customer/{customerId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _generate_analytics_report_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class GenerateAnalyticsReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_analytics_report(
        self,
        customer_id: str,
        account_ids: typing.Optional[typing.List[int]] = None,
        length_of_report: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._generate_analytics_report_mapped_args(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
        )
        return await self._agenerate_analytics_report_oapg(
            body=args.body,
    ...
    def generate_analytics_report(
        ...
        return self._generate_analytics_report_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class GenerateAnalyticsReport(BaseApi):
    ...
    async def agenerate_analytics_report(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_analytics_report(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
    ...
    def generate_analytics_report(
        ...
        raw_response = self.raw.generate_analytics_report(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
