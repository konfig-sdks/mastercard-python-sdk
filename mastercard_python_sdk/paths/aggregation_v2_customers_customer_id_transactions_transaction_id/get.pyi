...
from mastercard_python_sdk.model.transaction import Transaction as TransactionSchema
...
from mastercard_python_sdk.pydantic.transaction import Transaction as TransactionPydantic
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v2/customers/{customerId}/transactions/{transactionId}',
            auth_settings=_auth,
            headers=_headers,
        )
