...
from mastercard_python_sdk.model.voa_report_constraints import VOAReportConstraints as VOAReportConstraintsSchema
from mastercard_python_sdk.model.voa_report_ack import VOAReportAck as VOAReportAckSchema
...
from mastercard_python_sdk.type.voa_report_ack import VOAReportAck
from mastercard_python_sdk.type.voa_report_constraints import VOAReportConstraints
...
from mastercard_python_sdk.pydantic.voa_report_ack import VOAReportAck as VOAReportAckPydantic
from mastercard_python_sdk.pydantic.voa_report_constraints import VOAReportConstraints as VOAReportConstraintsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = VOAReportConstraintsSchema


request_body_voa_report_constraints = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = VOAReportAckSchema
...
class BaseApi(api_client.Api):
    ...
    def _customer_voa_report_mapped_args(
        self,
        customer_id: str,
    ...
    async def _acustomer_voa_report_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v2/customers/{customerId}/voa',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_voa_report_constraints.serialize(body, content_type)
...
class CustomerVoaReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acustomer_voa_report(
        self,
        customer_id: str,
        account_ids: typing.Optional[str] = None,
        report_custom_fields: typing.Optional[ReportCustomFields] = None,
        ...
        **kwargs,
        ...
        args = self._customer_voa_report_mapped_args(
        ...
        return await self._acustomer_voa_report_oapg(
            body=args.body,
    ...
    def customer_voa_report(
        ...
        return self._customer_voa_report_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CustomerVoaReport(BaseApi):
    ...
    async def acustomer_voa_report(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VOAReportAckPydantic:
        raw_response = await self.raw.acustomer_voa_report(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            show_nsf=show_nsf,
        ...
        if validate:
            return RootModel[VOAReportAckPydantic](raw_response.body).root
        return api_client.construct_model_instance(VOAReportAckPydantic, raw_response.body)
    ...
    def customer_voa_report(
        ...
        raw_response = self.raw.customer_voa_report(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            show_nsf=show_nsf,
