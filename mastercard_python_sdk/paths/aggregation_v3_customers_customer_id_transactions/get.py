...
class BaseApi(api_client.Api):
    ...
    def _get_all_customer_transactions_mapped_args(
        self,
        customer_id: str,
        from_date: int,
        to_date: int,
    ...
    async def _aget_all_customer_transactions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v3/customers/{customerId}/transactions',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_all_customer_transactions_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetAllCustomerTransactionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_customer_transactions(
        self,
        customer_id: str,
        from_date: int,
        to_date: int,
        ...
        **kwargs,
        ...
        args = self._get_all_customer_transactions_mapped_args(
        ...
        return await self._aget_all_customer_transactions_oapg(
    ...
    def get_all_customer_transactions(
        ...
        return self._get_all_customer_transactions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllCustomerTransactions(BaseApi):
    ...
    async def aget_all_customer_transactions(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_customer_transactions(
            customer_id=customer_id,
            from_date=from_date,
            to_date=to_date,
            start=start,
    ...
    def get_all_customer_transactions(
        ...
        raw_response = self.raw.get_all_customer_transactions(
            customer_id=customer_id,
            from_date=from_date,
            to_date=to_date,
            start=start,
