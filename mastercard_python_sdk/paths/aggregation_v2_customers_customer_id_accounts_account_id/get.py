...
from mastercard_python_sdk.model.customer_account import CustomerAccount as CustomerAccountSchema

from mastercard_python_sdk.type.customer_account import CustomerAccount
...
from mastercard_python_sdk.pydantic.customer_account import CustomerAccount as CustomerAccountPydantic
...
SchemaFor200ResponseBodyApplicationJson = CustomerAccountSchema
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v2/customers/{customerId}/accounts/{accountId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        **kwargs,
        ...
        if validate:
            return CustomerAccountPydantic(**raw_response.body)
        return api_client.construct_model_instance(CustomerAccountPydantic, raw_response.body)
