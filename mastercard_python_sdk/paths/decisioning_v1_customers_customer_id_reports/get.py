...
from mastercard_python_sdk.model.report_summaries import ReportSummaries as ReportSummariesSchema

from mastercard_python_sdk.type.report_summaries import ReportSummaries
...
from mastercard_python_sdk.pydantic.report_summaries import ReportSummaries as ReportSummariesPydantic
...
SchemaFor200ResponseBodyApplicationJson = ReportSummariesSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReportSummaries
...
class BaseApi(api_client.Api):
    ...
    def _by_customer_id_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aby_customer_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v1/customers/{customerId}/reports',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ByCustomerIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aby_customer_id(
        self,
        customer_id: str,
        purpose: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._by_customer_id_mapped_args(
            customer_id=customer_id,
            purpose=purpose,
        )
        return await self._aby_customer_id_oapg(
    ...
    def by_customer_id(
        ...
        return self._by_customer_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ByCustomerId(BaseApi):
    ...
    async def aby_customer_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReportSummariesPydantic:
        raw_response = await self.raw.aby_customer_id(
            customer_id=customer_id,
            purpose=purpose,
            **kwargs,
        )
        if validate:
            return ReportSummariesPydantic(**raw_response.body)
        return api_client.construct_model_instance(ReportSummariesPydantic, raw_response.body)
    ...
    def by_customer_id(
        ...
        raw_response = self.raw.by_customer_id(
            customer_id=customer_id,
            purpose=purpose,
        )
        if validate:
