...
from mastercard_python_sdk.model.customer_update import CustomerUpdate as CustomerUpdateSchema

from mastercard_python_sdk.type.error_message import ErrorMessage
from mastercard_python_sdk.type.customer_update import CustomerUpdate

from ...api_client import Dictionary
from mastercard_python_sdk.pydantic.error_message import ErrorMessage as ErrorMessagePydantic
from mastercard_python_sdk.pydantic.customer_update import CustomerUpdate as CustomerUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = CustomerUpdateSchema


request_body_customer_update = api_client.RequestBody(
    content={
    ...
    async def _amodify_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_customer_update.serialize(body, content_type)
