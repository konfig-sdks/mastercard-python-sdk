...
class BaseApi(api_client.Api):
    ...
    def _assign_applications_mapped_args(
        self,
        customer_id: str,
        application_id: str,
    ...
    async def _aassign_applications_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v1/customers/{customerId}/applications/{applicationId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class AssignApplicationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aassign_applications(
        self,
        customer_id: str,
        application_id: str,
        **kwargs,
        ...
        args = self._assign_applications_mapped_args(
            customer_id=customer_id,
            application_id=application_id,
        )
        return await self._aassign_applications_oapg(
    ...
    def assign_applications(
        ...
        return self._assign_applications_oapg(
            path_params=args.path,
        )

class AssignApplications(BaseApi):
    ...
    async def aassign_applications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aassign_applications(
            customer_id=customer_id,
            application_id=application_id,
            **kwargs,
        )
    ...
    def assign_applications(
        ...
        raw_response = self.raw.assign_applications(
            customer_id=customer_id,
            application_id=application_id,
        )
