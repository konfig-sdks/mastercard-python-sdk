...
class BaseApi(api_client.Api):
    ...
    def _disable_notifications_mapped_args(
        self,
        customer_id: str,
        account_id: str,
    ...
    async def _adisable_notifications_oapg(
        self,
    ...
    def _disable_notifications_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DisableNotificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adisable_notifications(
        self,
        customer_id: str,
        account_id: str,
        **kwargs,
        ...
        args = self._disable_notifications_mapped_args(
            customer_id=customer_id,
            account_id=account_id,
        )
        return await self._adisable_notifications_oapg(
    ...
    def disable_notifications(
        ...
        return self._disable_notifications_oapg(
            path_params=args.path,
        )

class DisableNotifications(BaseApi):
    ...
    async def adisable_notifications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adisable_notifications(
            customer_id=customer_id,
            account_id=account_id,
            **kwargs,
        )
    ...
    def disable_notifications(
        ...
        raw_response = self.raw.disable_notifications(
            customer_id=customer_id,
            account_id=account_id,
        )
