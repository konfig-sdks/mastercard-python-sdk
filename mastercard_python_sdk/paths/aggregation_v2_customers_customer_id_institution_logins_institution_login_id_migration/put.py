...
class BaseApi(api_client.Api):
    ...
    def _migrate_institution_login_accounts_mapped_args(
        self,
        customer_id: str,
    ...
    async def _amigrate_institution_login_accounts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/aggregation/v2/customers/{customerId}/institutionLogins/{institutionLoginId}/migration',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _migrate_institution_login_accounts_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class MigrateInstitutionLoginAccountsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amigrate_institution_login_accounts(
        self,
        customer_id: str,
        institution_login_id: str,
        **kwargs,
        ...
        args = self._migrate_institution_login_accounts_mapped_args(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
        return await self._amigrate_institution_login_accounts_oapg(
    ...
    def migrate_institution_login_accounts(
        ...
        return self._migrate_institution_login_accounts_oapg(
            path_params=args.path,
        )

class MigrateInstitutionLoginAccounts(BaseApi):
    ...
    async def amigrate_institution_login_accounts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amigrate_institution_login_accounts(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
            **kwargs,
        )
    ...
    def migrate_institution_login_accounts(
        ...
        raw_response = self.raw.migrate_institution_login_accounts(
            customer_id=customer_id,
            institution_login_id=institution_login_id,
        )
        if validate:
