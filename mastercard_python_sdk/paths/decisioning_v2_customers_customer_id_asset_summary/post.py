...
class BaseApi(api_client.Api):
    ...
    def _get_asset_summary_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aget_asset_summary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v2/customers/{customerId}/assetSummary',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAssetSummaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_asset_summary(
        self,
        customer_id: str,
        account_ids: typing.Optional[str] = None,
        report_custom_fields: typing.Optional[ReportCustomFields] = None,
        ...
        **kwargs,
        ...
        args = self._get_asset_summary_mapped_args(
        ...
        return await self._aget_asset_summary_oapg(
            body=args.body,
    ...
    def get_asset_summary(
        ...
        return self._get_asset_summary_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class GetAssetSummary(BaseApi):
    ...
    async def aget_asset_summary(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_asset_summary(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            show_nsf=show_nsf,
    ...
    def get_asset_summary(
        ...
        raw_response = self.raw.get_asset_summary(
            customer_id=customer_id,
            account_ids=account_ids,
            report_custom_fields=report_custom_fields,
            show_nsf=show_nsf,
