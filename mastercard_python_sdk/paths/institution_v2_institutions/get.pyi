...
from mastercard_python_sdk.model.institutions import Institutions as InstitutionsSchema

from mastercard_python_sdk.type.institutions import Institutions
...
from mastercard_python_sdk.pydantic.institutions import Institutions as InstitutionsPydantic
...
SchemaFor200ResponseBodyApplicationJson = InstitutionsSchema
...
class BaseApi(api_client.Api):
    ...
    def _search_financial_institutions_mapped_args(
        self,
    ...
    async def _asearch_financial_institutions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/institution/v2/institutions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class SearchFinancialInstitutionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asearch_financial_institutions(
        self,
        search: typing.Optional[str] = None,
        start: typing.Optional[int] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._search_financial_institutions_mapped_args(
            search=search,
            start=start,
            limit=limit,
            type=type,
        ...
        return await self._asearch_financial_institutions_oapg(
...
class SearchFinancialInstitutions(BaseApi):
    ...
    async def asearch_financial_institutions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> InstitutionsPydantic:
        raw_response = await self.raw.asearch_financial_institutions(
            search=search,
            start=start,
            limit=limit,
            type=type,
        ...
        if validate:
            return InstitutionsPydantic(**raw_response.body)
        return api_client.construct_model_instance(InstitutionsPydantic, raw_response.body)
    ...
    def search_financial_institutions(
        ...
        raw_response = self.raw.search_financial_institutions(
            search=search,
            start=start,
            limit=limit,
            type=type,
