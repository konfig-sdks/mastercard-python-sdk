...
from mastercard_python_sdk.model.statement_report_constraints import StatementReportConstraints as StatementReportConstraintsSchema
from mastercard_python_sdk.model.statement_report_ack import StatementReportAck as StatementReportAckSchema
from mastercard_python_sdk.model.error_message import ErrorMessage as ErrorMessageSchema
from mastercard_python_sdk.model.statement_data import StatementData as StatementDataSchema
...
from mastercard_python_sdk.type.statement_report_constraints import StatementReportConstraints
from mastercard_python_sdk.type.statement_report_ack import StatementReportAck
...
from mastercard_python_sdk.pydantic.statement_report_ack import StatementReportAck as StatementReportAckPydantic
from mastercard_python_sdk.pydantic.statement_report_constraints import StatementReportConstraints as StatementReportConstraintsPydantic
from mastercard_python_sdk.pydantic.statement_data import StatementData as StatementDataPydantic
...
# body param
SchemaForRequestBodyApplicationJson = StatementReportConstraintsSchema


request_body_statement_report_constraints = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = StatementReportAckSchema


@dataclass
class ApiResponseFor202(api_client.ApiResponse):
    body: StatementReportAck
...
class BaseApi(api_client.Api):
    ...
    def _generate_report_mapped_args(
        ...
        _path_params = {}
        _body = {}
        if statement_report_data is not None:
            _body["statementReportData"] = statement_report_data
    ...
    async def _agenerate_report_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/decisioning/v2/customers/{customerId}/statement',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_statement_report_constraints.serialize(body, content_type)
    ...
    async def agenerate_report(
        ...
        **kwargs,
        ...
        args = self._generate_report_mapped_args(
            statement_report_data=statement_report_data,
...
class GenerateReport(BaseApi):
    ...
    async def agenerate_report(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[StatementReportAckPydantic](raw_response.body).root
        return api_client.construct_model_instance(StatementReportAckPydantic, raw_response.body)
