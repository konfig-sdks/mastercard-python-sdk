...
class BaseApi(api_client.Api):
    ...
    def _generate_analytics_mapped_args(
        self,
        customer_id: str,
    ...
    async def _agenerate_analytics_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/analytics/cashflow/v1/customer/{customerId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class GenerateAnalyticsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_analytics(
        self,
        customer_id: str,
        account_ids: typing.Optional[typing.List[int]] = None,
        length_of_report: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._generate_analytics_mapped_args(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
        )
        return await self._agenerate_analytics_oapg(
            body=args.body,
    ...
    def generate_analytics(
        ...
        return self._generate_analytics_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class GenerateAnalytics(BaseApi):
    ...
    async def agenerate_analytics(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_analytics(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
    ...
    def generate_analytics(
        ...
        raw_response = self.raw.generate_analytics(
            customer_id=customer_id,
            account_ids=account_ids,
            length_of_report=length_of_report,
            reference_number=reference_number,
