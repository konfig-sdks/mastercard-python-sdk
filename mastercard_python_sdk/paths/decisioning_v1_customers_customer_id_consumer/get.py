...
from mastercard_python_sdk.model.consumer import Consumer as ConsumerSchema
from mastercard_python_sdk.model.error_message import ErrorMessage as ErrorMessageSchema

from mastercard_python_sdk.type.consumer import Consumer
from mastercard_python_sdk.type.error_message import ErrorMessage

from ...api_client import Dictionary
from mastercard_python_sdk.pydantic.consumer import Consumer as ConsumerPydantic
...
SchemaFor200ResponseBodyApplicationJson = ConsumerSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_customer_id_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aget_by_customer_id_oapg(
        self,
...
class GetByCustomerIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_customer_id(
        self,
        customer_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_by_customer_id_mapped_args(
            customer_id=customer_id,
        )
        return await self._aget_by_customer_id_oapg(
    ...
    def get_by_customer_id(
        ...
        return self._get_by_customer_id_oapg(
            path_params=args.path,
        )

class GetByCustomerId(BaseApi):
    ...
    async def aget_by_customer_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_customer_id(
            customer_id=customer_id,
            **kwargs,
        )
        if validate:
            return ConsumerPydantic(**raw_response.body)
        return api_client.construct_model_instance(ConsumerPydantic, raw_response.body)
    ...
    def get_by_customer_id(
        ...
        raw_response = self.raw.get_by_customer_id(
            customer_id=customer_id,
        )
        if validate:
            return ConsumerPydantic(**raw_response.body)
