...
from mastercard_python_sdk.model.lite_connect_parameters import LiteConnectParameters as LiteConnectParametersSchema

from mastercard_python_sdk.type.connect_url import ConnectUrl
from mastercard_python_sdk.type.lite_connect_parameters import LiteConnectParameters
...
from mastercard_python_sdk.pydantic.lite_connect_parameters import LiteConnectParameters as LiteConnectParametersPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = LiteConnectParametersSchema


request_body_lite_connect_parameters = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _generate_lite_url_mapped_args(
        self,
        partner_id: str,
        customer_id: str,
        institution_id: int,
        ...
        if institution_id is not None:
            _body["institutionId"] = institution_id
    ...
    async def _agenerate_lite_url_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/connect/v2/generate/lite',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_lite_connect_parameters.serialize(body, content_type)
...
class GenerateLiteUrlRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def agenerate_lite_url(
        self,
        partner_id: str,
        customer_id: str,
        institution_id: int,
        ...
        **kwargs,
        ...
        args = self._generate_lite_url_mapped_args(
        ...
        return await self._agenerate_lite_url_oapg(
            body=args.body,
            **kwargs,
        )
    
    def generate_lite_url(
        self,
        partner_id: str,
        customer_id: str,
        institution_id: int,
        ...
        return self._generate_lite_url_oapg(
            body=args.body,
        )

class GenerateLiteUrl(BaseApi):
    ...
    async def agenerate_lite_url(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.agenerate_lite_url(
            partner_id=partner_id,
            customer_id=customer_id,
            institution_id=institution_id,
            language=language,
    ...
    def generate_lite_url(
        ...
        raw_response = self.raw.generate_lite_url(
            partner_id=partner_id,
            customer_id=customer_id,
            institution_id=institution_id,
            language=language,
